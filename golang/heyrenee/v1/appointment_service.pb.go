...
type ListAppointmentsRequest struct {
	...
	// The total number of results to include in a single page of results. Minimum is 1, maximum is 1000, and default is
	// 25.
...
func (x *ListAppointmentsRequest) GetPageCount() int64 {
	if x != nil {
		return x.PageCount
	}
	return 0
...
var file_heyrenee_v1_appointment_service_proto_rawDesc = []byte{
	...
	0x63, 0x6f, 0x75, 0x6e, 0x74, 0x18, 0x02, 0x20, 0x01, 0x28, 0x03, 0x52, 0x09, 0x70, 0x61, 0x67,
