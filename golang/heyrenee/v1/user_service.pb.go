...
var file_heyrenee_v1_user_service_proto_rawDesc = []byte{
	...
	0x74, 0x69, 0x65, 0x6e, 0x74, 0x52, 0x07, 0x70, 0x61, 0x74, 0x69, 0x65, 0x6e, 0x74, 0x22, 0x57,
	...
	0x72, 0x65, 0x67, 0x69, 0x76, 0x65, 0x72, 0x22, 0x57, 0x0a, 0x16, 0x43, 0x72, 0x65, 0x61, 0x74,
	0x65, 0x43, 0x6f, 0x6e, 0x63, 0x69, 0x65, 0x72, 0x67, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73,
	0x74, 0x12, 0x3d, 0x0a, 0x09, 0x63, 0x6f, 0x6e, 0x63, 0x69, 0x65, 0x72, 0x67, 0x65, 0x18, 0x01,
	...
	0x69, 0x65, 0x72, 0x67, 0x65, 0x52, 0x09, 0x63, 0x6f, 0x6e, 0x63, 0x69, 0x65, 0x72, 0x67, 0x65,
	...
	0x65, 0x6e, 0x74, 0x22, 0x00, 0x12, 0x59, 0x0a, 0x0f, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x43,
	...
	0x12, 0x59, 0x0a, 0x0f, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x43, 0x6f, 0x6e, 0x63, 0x69, 0x65,
	0x72, 0x67, 0x65, 0x12, 0x23, 0x2e, 0x68, 0x65, 0x79, 0x72, 0x65, 0x6e, 0x65, 0x65, 0x2e, 0x76,
	0x31, 0x2e, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x43, 0x6f, 0x6e, 0x63, 0x69, 0x65, 0x72, 0x67,
	0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x1f, 0x2e, 0x68, 0x65, 0x79, 0x72, 0x65,
	0x6e, 0x65, 0x65, 0x2e, 0x76, 0x31, 0x2e, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x73, 0x2e,
	0x43, 0x6f, 0x6e, 0x63, 0x69, 0x65, 0x72, 0x67, 0x65, 0x22, 0x00, 0x42, 0x31, 0x5a, 0x2f, 0x67,
...
var file_heyrenee_v1_user_service_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_heyrenee_v1_user_service_proto_goTypes = []interface{}{
	(*CreatePatientRequest)(nil),   // 0: heyrenee.v1.CreatePatientRequest
	(*CreateCaregiverRequest)(nil), // 1: heyrenee.v1.CreateCaregiverRequest
	(*CreateConciergeRequest)(nil), // 2: heyrenee.v1.CreateConciergeRequest
	(*messages.Patient)(nil),       // 3: heyrenee.v1.messages.Patient
	(*messages.Caregiver)(nil),     // 4: heyrenee.v1.messages.Caregiver
	(*messages.Concierge)(nil),     // 5: heyrenee.v1.messages.Concierge
}
var file_heyrenee_v1_user_service_proto_depIdxs = []int32{
	3, // 0: heyrenee.v1.CreatePatientRequest.patient:type_name -> heyrenee.v1.messages.Patient
	4, // 1: heyrenee.v1.CreateCaregiverRequest.caregiver:type_name -> heyrenee.v1.messages.Caregiver
	5, // 2: heyrenee.v1.CreateConciergeRequest.concierge:type_name -> heyrenee.v1.messages.Concierge
	0, // 3: heyrenee.v1.UserService.CreatePatient:input_type -> heyrenee.v1.CreatePatientRequest
	1, // 4: heyrenee.v1.UserService.CreateCaregiver:input_type -> heyrenee.v1.CreateCaregiverRequest
	2, // 5: heyrenee.v1.UserService.CreateConcierge:input_type -> heyrenee.v1.CreateConciergeRequest
	3, // 6: heyrenee.v1.UserService.CreatePatient:output_type -> heyrenee.v1.messages.Patient
	4, // 7: heyrenee.v1.UserService.CreateCaregiver:output_type -> heyrenee.v1.messages.Caregiver
	5, // 8: heyrenee.v1.UserService.CreateConcierge:output_type -> heyrenee.v1.messages.Concierge
