...
type Insurance struct {
	...
	ClaimsAddressLines      string          `protobuf:"bytes,15,opt,name=claims_address_lines,json=claimsAddressLines,proto3" json:"claims_address_lines,omitempty"`
	...
	RxClaimsAddressLines    string          `protobuf:"bytes,29,opt,name=rx_claims_address_lines,json=rxClaimsAddressLines,proto3" json:"rx_claims_address_lines,omitempty"`
...
var file_heyrenee_v1_messages_insurance_proto_rawDesc = []byte{
	...
	0x0f, 0x20, 0x01, 0x28, 0x09, 0x52, 0x12, 0x63, 0x6c, 0x61, 0x69, 0x6d, 0x73, 0x41, 0x64, 0x64,
	...
	0x72, 0x65, 0x73, 0x73, 0x5f, 0x6c, 0x69, 0x6e, 0x65, 0x73, 0x18, 0x1d, 0x20, 0x01, 0x28, 0x09,
