...
type Prescription struct {
	...
	PrescriptionId string                    `protobuf:"bytes,5,opt,name=prescription_id,json=prescriptionId,proto3" json:"prescription_id,omitempty"`
	// Types that are assignable to Provider:
	//	*Prescription_ProviderId
	//	*Prescription_ProviderMessage
	Provider                                isPrescription_Provider `protobuf_oneof:"provider"`
	ProviderInstructions                    string                  `protobuf:"bytes,8,opt,name=provider_instructions,json=providerInstructions,proto3" json:"provider_instructions,omitempty"`
	PatientInstructions                     string                  `protobuf:"bytes,9,opt,name=patient_instructions,json=patientInstructions,proto3" json:"patient_instructions,omitempty"`
	RefillCount                             int64                   `protobuf:"varint,10,opt,name=refill_count,json=refillCount,proto3" json:"refill_count,omitempty"`
	RefillFrequency                         *durationpb.Duration    `protobuf:"bytes,11,opt,name=refill_frequency,json=refillFrequency,proto3" json:"refill_frequency,omitempty"`
	PrescriptionStatus                      PrescriptionStatus      `protobuf:"varint,12,opt,name=prescription_status,json=prescriptionStatus,proto3,enum=heyrenee.v1.messages.PrescriptionStatus" json:"prescription_status,omitempty"`
	FirstMedicationRegimenStart             *timestamppb.Timestamp  `protobuf:"bytes,13,opt,name=first_medication_regimen_start,json=firstMedicationRegimenStart,proto3" json:"first_medication_regimen_start,omitempty"`
	MedicationRegimenDuration               *durationpb.Duration    `protobuf:"bytes,14,opt,name=medication_regimen_duration,json=medicationRegimenDuration,proto3" json:"medication_regimen_duration,omitempty"`
	MedicationDosesPerRegimen               int64                   `protobuf:"varint,15,opt,name=medication_doses_per_regimen,json=medicationDosesPerRegimen,proto3" json:"medication_doses_per_regimen,omitempty"`
	MedicationDoseDurationsFromRegimenStart []*durationpb.Duration  `protobuf:"bytes,16,rep,name=medication_dose_durations_from_regimen_start,json=medicationDoseDurationsFromRegimenStart,proto3" json:"medication_dose_durations_from_regimen_start,omitempty"`
}
...
type Prescription_MedicationId struct {
	MedicationId string `protobuf:"bytes,3,opt,name=medication_id,json=medicationId,proto3,oneof"`
}

type Prescription_MedicationMessage struct {
	MedicationMessage *Medication `protobuf:"bytes,4,opt,name=medication_message,json=medicationMessage,proto3,oneof"`
}
...
type Prescription_ProviderId struct {
	ProviderId string `protobuf:"bytes,6,opt,name=provider_id,json=providerId,proto3,oneof"`
}

type Prescription_ProviderMessage struct {
	ProviderMessage *Provider `protobuf:"bytes,7,opt,name=provider_message,json=providerMessage,proto3,oneof"`
}
...
var file_heyrenee_v1_messages_prescription_proto_rawDesc = []byte{
	...
	,
	...
	,
